...
if __name__ == '__main__':
    ...
    pth_folder = f'pth_{args.mode}/{args.source}_{args.target}_{args.mode}_{args.num}/{time_str}_window{args.window_size}_context{args.context_size}_seed{args.seed}'
