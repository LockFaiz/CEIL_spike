...
if __name__ == '__main__':
    ...
    logger_folder=str.format(
                "ceil/logs_debug/{}_{}_{}_{}_{}/window{}_context{}_seed{}_{}", 
    ...
    pth_folder = f'pth_{args.mode}/{args.source}_{args.target}_{args.mode}_{args.num}_{args.demo}/{time_str}_window{args.window_size}_context{args.context_size}_seed{args.seed}'
    pth_folder = os.path.join(abs_dir, pth_folder)
    if not os.path.exists(pth_folder):
        os.makedirs(pth_folder + '/actor')
        os.makedirs(pth_folder + '/encoder')
    ceil_trainer = CEIL(
        ...
        actor_cls=ContextualActorSpike,
        encoder_cls=TrajEncoderSpike,
